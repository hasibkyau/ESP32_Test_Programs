...
void CarMove() {
  ...
  if (valC == 0 && valA == 1 && valB == 0) {
    motorB.Speed(SB); motorA.Speed(SA);
    motorA.Forward();// Motor Forward(Speed);
    motorB.Forward();
  ...
  //for smooth right turn
    ...
    motorB.Speed(SB); motorA.Speed(210);
    motorA.Forward();// Motor Forward(Speed);
    motorB.Forward();
  }
  ...
  //for smooth left turn
    ...
    motorB.Speed(210); motorA.Speed(SA);
    motorA.Forward();// Motor Forward(Speed);
    motorB.Forward();
  }
  ...
  // curvy right turn
    ...
    motorB.Speed(SB); motorA.Speed(0);
    motorA.Forward();// Motor Forward(Speed);
    motorB.Forward();
  }
  ...
  //  curvy left turn
    ...
    motorB.Speed(0); motorA.Speed(SA);
    motorA.Forward();// Motor Forward(Speed);
    motorB.Forward();
  }
