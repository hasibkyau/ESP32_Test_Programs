...
int IRA = 32, IRB = 33, IRC = 34, IRD = 24, IRE = 19; //IRD = Right side IR
...
void ActivateIR(){
  ...
  Serial.print("IR:");
  Serial.print(valA); //right
  Serial.print(":");
  Serial.print(valB); //left
  Serial.print(":");
  Serial.print(valC);
  Serial.print(":");
  Serial.print(valD);
...
void CarMove() {
  ...
  if (valC == 0 && valA == 1 && valB == 0) {
    motorA.Speed(240); motorB.Speed(240);
  ...
  //for smooth right turn
    ...
    motorB.Speed(240); motorA.Speed(200);
    motorA.Forward();// Motor Forward(Speed);
    motorB.Forward();
  }
  ...
  //for smooth left turn
    ...
    motorB.Speed(200); motorA.Speed(240);
    motorA.Forward();// Motor Forward(Speed);
    motorB.Forward();
  }
  ...
  //curvy left turn
    ...
    motorA.Speed(200); motorB.Speed(200);
    motorA.Forward();
    motorB.Forward();
    //Serial.println("Stop");
  }
